...
class CreateSVSpiceProductionIncomePctTable extends Migration {
	...
	public function up()
	{
		Schema::connection('mysql2')->create('SV_SpiceProductionIncomePct', function(Blueprint $table)
		{
	...
	{
		Schema::connection('mysql2')->drop('SV_SpiceProductionIncomePct');
	}
