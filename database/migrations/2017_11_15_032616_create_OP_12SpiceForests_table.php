...
class CreateOP12SpiceForestsTable extends Migration {
	...
	public function up()
	{
		Schema::connection('mysql2')->create('OP_12SpiceForests', function(Blueprint $table)
		{
	...
	{
		Schema::connection('mysql2')->drop('OP_12SpiceForests');
	}
