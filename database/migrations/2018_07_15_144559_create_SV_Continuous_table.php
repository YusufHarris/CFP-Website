...
class CreateSVContinuousTable extends Migration {
	...
	public function up()
	{
		Schema::connection('mysql2')->create('SV_Continuous', function(Blueprint $table)
		{
			...
			$table->text('cropsGrown12')->nullable();
			...
			$table->text('extWorkersType12')->nullable();
			$table->smallInteger('farmSize12')->nullable();
			...
			$table->text('hireExtWorkers12')->nullable();
			...
			$table->smallInteger('ipm12')->nullable();
			$table->text('landUseHistory12')->nullable();
			...
			$table->smallInteger('numFamily12')->nullable();
			...
			$table->smallInteger('phpsClearingUnderstory12')->nullable();
			$table->smallInteger('phpsHarvesting12')->nullable();
			$table->smallInteger('phpsIrrigation12')->nullable();
			$table->smallInteger('phpsPruning12')->nullable();
			...
			$table->text('soilType12')->nullable();
	...
	{
		Schema::connection('mysql2')->drop('SV_Continuous');
	}
