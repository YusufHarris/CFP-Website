...
class CreateOP00LinkToComMembersTable extends Migration {
	...
	public function up()
	{
		Schema::connection('mysql2')->create('OP_00LinkToComMembers', function(Blueprint $table)
		{
	...
	{
		Schema::connection('mysql2')->drop('OP_00LinkToComMembers');
	}
