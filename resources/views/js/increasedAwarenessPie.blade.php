...
*/
class AwarenessPieChart extends Chart {
    ...
    */
    constructor(selector, params={}) {
        ...
        this.fullSet = <?php echo json_encode( $awareness ) ?>;
    ...
    */
    drawDoughnut() {
        ...
        this.newGroup('increasedAwarenessDoughnut');

        var color = d3.scaleOrdinal(['#FF9FCC','#FC0076']);
        ...
        var arc = this.increasedAwarenessDoughnut
...
const increasedAwarenessPie = new AwarenessPieChart(
