...
*/
class KnowOthersPieChart extends Chart {
    ...
    */
    constructor(selector, params={}) {
        ...
        this.fullSet = <?php echo json_encode( $knowOthers )?>;
    ...
    */
    drawDoughnut() {
        ...
        this.newGroup('knowOthersDoughnut');

        var color = d3.scaleOrdinal(['#464BC1','#ACAEDC']);
        ...
        var arc = this.knowOthersDoughnut
...
const knowOthersPie = new KnowOthersPieChart(
    '#knowOthersPie',
    {
        margin: {
            top: 10,
