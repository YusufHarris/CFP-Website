...
*/
class TreesPlantedBarChart extends Chart {
    constructor(selector, params={}) {
        // Set the parent class parameters
        super(selector, params);

        // Get the full data set
        this.fullSet = <?php echo json_encode( $treesPlanted ) ?>;
    ...
    */
    getTotalTrees() {
        ...
        for (var x in this.fullSet) {
            cnt += (this.fullSet[x].totalTrees*1);
        }
    ...
    */
    drawBars() {
        ...
        xMin = -1500,//this is the minimum value that the chart will graph
        //(for aesthetic purposes some values will be graphed innacurately)
        xMax = (36000),
        ...
        this.newGroup('treeBars');

        // Draw the bars of the chart
        var treeBarholder = this.treeBars
            .selectAll('g.bars')
        ...
        treeBarholder.append('rect')
            ...
            .attr('width', function(d){
                return xScale(d.totalTrees);
            });

        treeBarholder.append("svg:title")
        .text(function(d) { return d.name; });

        // Draw the label for the current data point
        treeBarholder.append('text')
            // Set the class
            .classed('xLabels', true)
            // Set the text using the trees Planted total
            .text(function(d){
                return numberWithCommas(d.totalTrees);
            })
    ...
    */
    drawTitle() {
        ...
        .text(numberWithCommas(`${this.getTotalTrees()} `))
...
const treesPlantedBar= new TreesPlantedBarChart(
    '#treesPlantedBar',
    {
        margin: {
            top: 315,
