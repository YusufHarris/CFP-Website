...
*/
class SolarHouseholdsBarChart extends Chart {
    constructor(selector, params={}) {
        // Set the parent class parameters
        super(selector, params);

        // Get the full data set
        this.fullSet = <?php echo json_encode( $solarHouseholds ) ?>;
    ...
    */
    getTotalHouseholds() {
        ...
        for (var x in this.fullSet) {
            cnt += (this.fullSet[x].totalHouseholds*1);
        }
    ...
    */
    drawBars() {
        ...
        yMin = -10,//for graph aesthetics
        yMax = d3.max(this.fullSet, function(d){ return parseInt(d.totalHouseholds); }),
        ...
        this.newGroup('householdBars');

        // Draw the bars of the chart
        var householdBarholder = this.householdBars
            .selectAll('g.bars')
        ...
        householdBarholder.append('rect')
            ...
            // height
            .attr('y', function(d){
                return height - yScale(d.totalHouseholds);
            })
            .attr('height', function(d){
                return yScale(d.totalHouseholds);
            });

      householdBarholder.append("svg:title")
        .text(function(d) { return d.community; });

        // Draw the label for the current data point
        householdBarholder.append('text')
            // Set the class
            .classed('yLabels', true)
            // Set the text using the trees Planted total
            .text(function(d){
                return numberWithCommas(d.totalHouseholds);
            })
            ...
            .attr('y', function(d){
                return height - yScale(d.totalHouseholds) + 15;
            });
    }
    ...
    */
    drawTitle() {
        ...
        .text(`${this.getTotalHouseholds()} Houses Acquire Solar Energy Equipment`)
...
const solarHouseholdsBar= new SolarHouseholdsBarChart(
    '#solarHouseholdsBar',
    {
        margin: {
            top: 40,
