...
*/
class WaterHHPieChart extends Chart {
    ...
    */
    constructor(selector, params={}) {
        ...
        this.fullSet = <?php echo json_encode( $waterHHs ) ?>;
    ...
    */
    drawDoughnut() {
        ...
        pie = d3.pie()
            .sort(null)
            .value(function(d) { return d.totalHH; });

        // Initialize this group
        this.newGroup('waterHHDoughnut');
        ...
        this.waterHHDoughnut
            .append('text')
            .attr('transform', 'translate(0,15)')
            .classed('Impr', true)
            .style('text-anchor', 'middle')
            .style('font', '54px sans-serif')
            .text(this.fullSet[0].totalHH + " HH");
...
const waterHHPie = new WaterHHPieChart(
    '#waterHHPie',
    {
        margin: {
            top: 10,
