...
*/
class EnergySystemsBarChart extends Chart {
    constructor(selector, params={}) {
        // Set the parent class parameters
        super(selector, params);

        // Get the full data set
        this.fullSet = <?php echo json_encode( $enSystems ) ?>;
    ...
    */
    getTotalSystems() {
        ...
        for (var x in this.fullSet) {
            cnt += (this.fullSet[x].totalSystems*1);
        }
    ...
    */
    drawBars() {
        ...
        yMax = d3.max(this.fullSet, function(d){ return parseInt(d.totalSystems); }),
        ...
        this.newGroup('enBars');

        // Draw the bars of the chart
        var enBarholder = this.enBars
            .selectAll('g.bars')
        ...
        enBarholder.append('rect')
            ...
            // height
            .attr('y', function(d){
                return height - yScale(d.totalSystems);
            })
            .attr('height', function(d){
                return yScale(d.totalSystems);
            });

      enBarholder.append("svg:title")
        .text(function(d) { return d.district; });

        // Draw the label for the current data point
        enBarholder.append('text')
            // Set the class
            .classed('yLabels', true)
            // Set the text using the trees Planted total
            .text(function(d){
                return numberWithCommas(d.totalSystems);
            })
            ...
            .attr('y', function(d){
                return height - yScale(d.totalSystems) + 15;
            });
    }
    ...
    */
    drawTitle() {
        ...
        .text(`${this.getTotalSystems()} Renewable Energy Systems`)
...
const energySystemsBar= new EnergySystemsBarChart(
    '#energySystemsBar',
    {
        margin: {
            top: 40,
