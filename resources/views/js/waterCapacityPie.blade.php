...
*/
class WaterCapPieChart extends Chart {
    ...
    */
    constructor(selector, params={}) {
        ...
        this.fullSet = <?php echo json_encode( $waCap ) ?>;
    ...
    */
    drawDoughnut() {
        ...
        pie = d3.pie()
            .sort(null)
            .value(function(d) { return d.totalCapacity; });

        // Initialize this group
        this.newGroup('waterCapDoughnut');
        ...
        this.waterCapDoughnut
            .append('text')
            .attr('transform', 'translate(0,15)')
            .classed('Impr', true)
            .style('text-anchor', 'middle')
            .style('font', '44px sans-serif')
            .text(numberWithCommas(this.fullSet[0].totalCapacity) + " L");
...
const waterCapPie = new WaterCapPieChart(
    '#waterCapacityPie',
    {
        margin: {
            top: 10,
